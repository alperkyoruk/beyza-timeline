...
// Fix the import path to use a relative path instead of an alias
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-purple-50 via-pink-50 to-blue-50">
      ...
      <main className="flex-1">
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-gradient-to-b from-pink-100 via-purple-50 to-blue-100 relative overflow-hidden">
          <FloatingHearts />
          <WelcomeConfetti />
